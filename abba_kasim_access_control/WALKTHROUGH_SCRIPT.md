...
**Live Render Deployment URL**: [https://access-audit-kasim.onrender.com](https://access-audit-kasim.onrender.com)  
**Health Check Endpoint**: [https://access-audit-kasim.onrender.com/health](https://access-audit-kasim.onrender.com/health)  
...
- **Live URL**: [https://access-audit-kasim.onrender.com](https://access-audit-kasim.onrender.com)
- **Role**: Lead Auditor & Security Admin
- **Username / Email**: `abba_auditor` *(or `abba@accessaudit.local`)*
- **Password**: `AuditAdminPassword123!`

---

### 💡 Presentation Recording Instructions for Abba Kasim:
...
3. **Open Live App First**: Open [https://access-audit-kasim.onrender.com](https://access-audit-kasim.onrender.com) in your browser before pressing record.
4. **Pacing**: Follow the timecode outline above to keep your video strictly within 2 to 3 minutes.
