...
class Permission(db.Model):
    ...
    category = db.Column(db.String(50), nullable=False) # 'System Admin', 'Data Access', 'Financial', 'HR', 'Network'
...
class Role(db.Model):
    ...
    def risk_score(self):
        """Calculate overall risk score for this role based on permission risk levels."""
...
class AuditFinding(db.Model):
    ...
    target_name = db.Column(db.String(120), nullable=False) # Role or User Name
...
class AuditLog(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    event_type = db.Column(db.String(50), nullable=False) # 'ADMIN_LOGIN', 'AUDIT_RUN', 'ROLE_UPDATED', 'REPORT_GENERATED', 'EVIDENCE_UPLOADED'
